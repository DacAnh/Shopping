...
<!-- Footer Start -->
<div class="container-fluid bg-dark text-white-50 footer pt-1 mt-5">
            ...
            <div class="row g-4">
                <div class="col-lg-6">
                    <a href="/">
                        ...
                        <p class="text-secondary mb-0">AnhSP</p>
                    </a>
                </div>
                <div class="col-lg-6">
        ...
        <div class="row g-5">
            <div class="col-lg-3 col-md-6">
                <div class="footer-item">
                    ...
                    <p class="mb-4">Chúng tôi cam kết chất lượng sản phẩm và
                        sự hài lòng của khách hàng luôn được ưu tiên hàng đầu</p>
                </div>
            </div>
            <div class="col-lg-3 col-md-6">
